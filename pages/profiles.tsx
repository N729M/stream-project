...
const Profiles = () => {
    ...
    return (
        <div>
            <p className="text-white text-4xl mt-5 ml-5">Profiles</p>
            <div className="flex items-center h-full justify-center">
                <div className="flex flex-col">
                    <h1 className="text-3xl md:text-6xl text-white text-center">Who is watching ?</h1>
                    <div className="flex items-enter justify-center gap-8 mt-10">
                        <div onClick={()=> { router.push("/") } }>
                            <div className="group flex-row w-44 mw-auto">
                                ...
                                group-hover:cursor-pointer group-hover:border-white overflow-hidden">
                                    <img src="/images/avatars-kings.png" alt="Profile avatar by default" />
                                </div>
